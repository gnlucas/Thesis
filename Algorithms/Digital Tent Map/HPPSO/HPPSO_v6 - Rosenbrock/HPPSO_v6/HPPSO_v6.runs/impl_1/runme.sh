...
HD_PWD='C:/Users/Lucas/OneDrive/22ieee-tcas-lucas/FPGA - Xilinx/HPPSO/HPPSO_v6 - Rosenbrock/HPPSO_v6/HPPSO_v6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HPPSO_v6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HPPSO_v6.tcl -notrace
