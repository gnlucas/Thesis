...
HD_PWD='C:/Users/lgnar/OneDrive/22jsa-lucas/FPGA - Xilinx/Tent map/tent_map.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tent_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tent_map.tcl
