...
HD_PWD='C:/Users/lgnar/OneDrive/22jsa-lucas/FPGA - Xilinx/Tent map/tent_map.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tent_map.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tent_map.tcl -notrace
